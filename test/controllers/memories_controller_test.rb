...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post memories_url, params: { memory: { city: @memory.city, content: @memory.content, country: @memory.country, date: @memory.date, image: @memory.image } }
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { city: @memory.city, content: @memory.content, country: @memory.country, date: @memory.date, image: @memory.image } }
